...
#define SQL_SELECT_MO "SELECT id, phoneNumber, shortNumber, receivedTime, deliveryTime, dispatchTime, deliveryCount, idService, serviceName, idQueue, msgText, status, errCode, errText \
FROM trafficMO \
WHERE status='QUEUED' \
